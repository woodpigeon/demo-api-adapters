...
module DemoApiAdapters
  
  class JsonClient

    include DemoApiAdapters::ExceptionHandling
    ...
    def initialize(options = {})
      ...
      @logger = options[:logger] || DemoApiAdapters::Base.logger
    ...
    DEFAULT_REQUEST_HEADERS = {
        ...
        'User-Agent' => "Demo Api Client v. #{DemoApiAdapters::VERSION}"
    }
    ...
    def get_raw(url)
      ignoring DemoApiAdapters::HTTPNotFound do
        get_raw!(url)
      end
    end
    ...
    def do_raw_request(method, url, params = nil)
      ...
      raise DemoApiAdapters::HTTPNotFound.new(e.http_code)

    rescue RestClient::Exception => e
      raise DemoApiAdapters::HTTPErrorResponse.new(e.response.code.to_i), e.response.body
    end
    ...
    def do_json_request(method, url, params = nil, additional_headers = {}, &create_response)
      ...
      begin
        ...
        raise DemoApiAdapters::HTTPErrorResponse.new(e.http_code, error_details), e.http_body
      end
    ...
    def do_request(method, url, params = nil, additional_headers = {})
      ...
      raise DemoApiAdapters::EndpointNotFound.new("Could not connect to #{url}")

    rescue RestClient::RequestTimeout => e
      logger.error loggable.merge(status: 'timeout', error_message: e.message, error_class: e.class.name, end_time: Time.now.to_f).to_json
      raise DemoApiAdapters::TimedOutException.new

    rescue RestClient::MaxRedirectsReached => e
      raise DemoApiAdapters::TooManyRedirects
